...
# C:\Users\kylem\Downloads\Images_For_Track_2\Images_For_Track_2
# C:\\Users\\kylem\\Desktop\\CA2-SelfDriving-main\\TrackTwoData#
# C:\Users\kylem\Desktop\CA2-SelfDriving-main\BetterTrackTwo 
datadir = "C:\\Users\\kylem\\Desktop\\CA2-SelfDriving-main\\BetterTrackTwo"
...
X_train, X_valid, y_train, y_valid = train_test_split(image_paths, steerings, test_size=0.2, random_state=6) # Change size of training
...
image = image_paths[random.randint(0,1000)]
original_img = mpimg.imread(image)
transformed_image = img_elastic_transform(original_img)
fig, axes = plt.subplots(1,2, figsize=(15,10))
fig.tight_layout()
axes[0].imshow(original_img)
axes[0].set_title('Original Image')
...
history = model.fit(batch_generator(X_train, y_train, 200, 1),steps_per_epoch=100,epochs=40,validation_data=batch_generator(X_valid, y_valid, 200, 0),validation_steps=200,verbose=1,shuffle=1)
